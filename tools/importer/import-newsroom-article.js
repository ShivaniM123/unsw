...
const PAGE_TEMPLATE = {
  ...
  description: 'UNSW newsroom archive article from the legacy newsroom section',
  urls: [
    'https://www.unsw.edu.au/newsroom/news/2007/03/hit-the-green-trail',
  ],
  blocks: [
    {
      name: 'hero-article',
